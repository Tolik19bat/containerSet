...
// const character = [{
//   name: 'Лучник',
//   name: 'Лучник',//задвоение свойства и значения
//   type: 'Bowman',
//   health: 50,
//   level: 3,
//   attack: 40,
...
export default class Team {                 //создаём класс
  ...
  addAll(...rest) {                    // метод добавления коллекции карточек
    this.members.add(...new Set(rest));//добавляем коллекцию без задвоений
    // console.log(this.members)
  }

  toArray(character) {           //метод конвертации объекта character в массив
    let array = [];              //создаём новый массив
    for (let item of character) {//методом перебора
      // console.log(item)
